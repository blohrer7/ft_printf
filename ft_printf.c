...
/*   Updated: 2024/11/14 08:59:46 by blohrer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//     // Test mit Hexadezimalzahlen (%x und %X)
//     ret_ft_printf = ft_printf("ft_printf - Hex Lowercase: %x, Uppercase: %X\n", 3735928559U, 3735928559U);
